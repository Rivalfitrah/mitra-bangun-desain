        ...
        <div className="min-h-screen bg-white p-4 md:p-6">
          ...
          <div className="bg-white border-l-4 border-[#243B83] p-4 rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.1)] mb-6">
            ...
            <p className="text-md text-gray-600 mt-1">
              Di halaman ini Anda dapat membuat dokumen laporan harian dengan
              mengisi beberapa pertanyaan, setelah itu silahkan download
              terlebih dahulu dokumennya karena pembuatan dokumen ini tidak
